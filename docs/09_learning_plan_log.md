...
#### Phase 2B — IPPO (independent PPO, 중앙 critic 없음) — 🔧 **run 1 = 2/3 seed 초과(§8 (h), `99937a1` 곡선); 안정화 재런(`cef170f`)으로 마감 예정**
